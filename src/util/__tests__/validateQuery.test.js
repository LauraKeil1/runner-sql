...
const eval_collectibleInvalidWithoutResults_2 = require("../__mockData__/server.mock")
  .eval_collectibleInvalidWithoutResults_2;
const eval_collectibleInvalidWithoutResults_3 = require("../__mockData__/server.mock")
  .eval_collectibleInvalidWithoutResults_3;
...
describe("Unit tests for validateQuery", () => {
  it("query is valid (without ';')", () => {
    ...
    return validateQuery(
      eval_collectibleValidWithoutResultsSameResults,
      eval_collectibleValidWithoutResultsSameResults.query2,
      "query2"
    ).then((collectible) => {
  ...
  it("query is invalid (no SELECT-statement)", () => {
    ...
    return validateQuery(
      eval_collectibleInvalidWithoutResults_1,
      eval_collectibleInvalidWithoutResults_1.query2,
      "query2"
    ).catch((collectible) => {
  ...
  it("query is invalid (DROP-statement)", () => {
    ...
    return validateQuery(
      eval_collectibleInvalidWithoutResults_3,
      eval_collectibleInvalidWithoutResults_3.query1,
      "query1"
    ).catch((collectible) => {
      expect(collectible).toMatchInlineSnapshot(`
        Object {
  ...
  it("query is invalid (continues after ';')", () => {
    ...
    return validateQuery(
      eval_collectibleInvalidWithoutResults_2,
      eval_collectibleInvalidWithoutResults_2.query1,
      "query1"
    ).catch((collectible) => {
      expect(collectible).toMatchInlineSnapshot(`
        Object {
