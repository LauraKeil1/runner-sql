...
// import mock data
const collectibleWithoutQuery1 = require("../__mockData__/server.mock")
  .collectibleWithoutQuery1;
const collectibleWithoutQuery2 = require("../__mockData__/server.mock")
  .collectibleWithoutQuery2;
...
describe("Unit tests for validateRequest", () => {
  ...
  it("query1 and query2 are included in the request", () => {
    expect.assertions(1);
    return validateRequest(collectibleValidWithoutResultsSameResults).then(
      (collectible) => {
